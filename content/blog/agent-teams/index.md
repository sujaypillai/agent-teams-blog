...
![The prompt that started it all — one input, three agents about to spin up](./images/frame_001.png)
...
![Three agents launched in parallel with role descriptions visible](./images/frame_003.png)
...
![All three agents working in parallel — note the teammate bar at the bottom](./images/frame_005.png)
...
![The architect delivers: data pipeline, search strategy, Azure Container Apps setup, and a cost estimate](./images/frame_008.png)
...
![The devil's advocate delivering critical analysis](./images/frame_009.png)
...
![The main agent synthesizing findings from all three teammates](./images/frame_010.png)
...
![The payoff — the devil's advocate made the design genuinely better](./images/frame_013.png)
...
`youtube: https://youtu.be/yXgHI6qg7JU`
